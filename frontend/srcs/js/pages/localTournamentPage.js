...
export const localTournamentPage = {
  getHtml() {
    ...
    <div class="control-bar__alias-set">
      ...
      <input type="text" name="alias" required placeholder="${globalState.player3Alias}" onfocus="this.placeholder=''" onblur="this.placeholder='${globalState.player3Alias}'" autocomplete="off">
      <input type="text" name="alias" required placeholder="${globalState.player4Alias}" onfocus="this.placeholder=''" onblur="this.placeholder='${globalState.player4Alias}'" autocomplete="off">
    </div>
